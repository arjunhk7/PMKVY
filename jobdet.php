...
<!-- Mirrored from templates.scriptsbundle.com/opportunities-v3/demo/single-job.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2017 14:13:44 GMT -->
<head>
                            ...
                            <div class="single-job-page">
                                <div class="job-short-detail">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                        <dl>
                                            <dt>Job Type:</dt>
                                            <dd><?php echo $row['job_type']; ?></dd>

                                            <dt>Job Experience:</dt>
                                            <dd><?php echo $row['job_experience']; ?></dd>



                                            <dt>Posted On:</dt>
                                            <dd><?php echo $row['create_date']; ?></dd>

                                            <dt>Last Date:</dt>
                                            <dd><?php echo $row['last_date']; ?></dd>
                                            ...
                                            <dd><?php echo $row['expect_salary']; ?></dd>
                                        </dl>
                                    </div>
                                </div>
                                ...
                                <div class="company-detail">
                                    ...
                                    <div class="company-contact-detail">
                                        <table>
                                            ...
                                            <tr>
                                                <th>Email:</th>
                                                <td> <?php echo $roow['email']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Phone:</th>
                                                <td> <?php echo $roow['phone']; ?></td>
                                            </tr>
                                                <th>Website:</th>
                                                <td><?php echo $roow['website']; ?></td>
                                            <tr>
                                                <th>Address:</th>
                                                <td><?php echo $roow['address']; ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
<!-- Mirrored from templates.scriptsbundle.com/opportunities-v3/demo/single-job.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2017 14:13:45 GMT -->
</html>
