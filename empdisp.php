...
<title>PMKVY EMPLOYERS APP</title>
            ...
            <div class="row">
                <div class="col-md-10 col-sm-12 col-md-offset-1 col-xs-12 nopadding">
                    <div class="search-form-contaner">
                        <h1 class="search-main-title"> Building careers. creating success stories </h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="cat-title">Browse Employees</div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <ul class="nav panel-tabs">
                                    <li> <a href="#tab1" name= "cat" data-toggle="tab"><i class="icofont icon-ribbon"></i><span class="hidden-xs hidden-sm">By Name</span></a> </li>
                                    <li> <a href="#tab2" name= "fun" data-toggle="tab"><i class="icofont icon-layers"></i><span class="hidden-xs hidden-sm">By Location</span></a> </li>
                                    <li class="active"> <a href="#tab3" name= "city" data-toggle="tab"><i class="icofont icon-global"></i><span class="hidden-xs hidden-sm">By Skills</span></a> </li>
                                      <li> <a href="#tab4" name= "type" data-toggle="tab"><i class="icofont icon-linegraph"></i><span class="hidden-xs hidden-sm">By Industry</span></a> </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                        <div class="job-box">
                                          ...
                                          define('DB_PASSWORD','');
                                           ...
                                           $query= "SELECT * FROM employee_user ORDER BY fname";
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <div class="job-title-box"> <a href="#">
                                                    <div class="job-title"> <?php echo $row['fname']; ?></div>
                                                  </a> <a href="#"><span class="comp-name"><?php echo $row['lname']; ?></span></a> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <div class="job-location"> <i class="fa fa-location-arrow"></i> <?php echo $row['state']; ?> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <div class="job-type jt-full-time-color"> <i class="fa fa-clock-o"></i> <?php echo $row['cert_id']; ?> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <button class="btn btn-primary btn-custom">Hire Now</button>
                                            </div>
                                ...
                                <div class="tab-pane animated fadeInDown" id="tab2">
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                      <div class="job-box">
                                        ...
                                        $query= "SELECT * FROM employee_user ORDER BY state";
                                          $data = mysqli_query($con,$query) or die("Fail17");
                                ...
                                <div class="tab-pane active animated fadeInLeft" id="tab4">
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                      <div class="job-box">
                                        <?php
