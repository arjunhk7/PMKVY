...
<div class="page">
                ...
                <div class="col-md-10 col-sm-12 col-md-offset-1 col-xs-12 nopadding">
                    <div class="search-form-contaner">
                                ...
                                <div class="form-group">
                                  <form name= "search" method="POST" id = 'search' action= 'show.php'>
                                    <input type="text" name = "word" class="form-control" name="keyword" placeholder="Search Keyword" value="">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 nopadding">
                                <div class="form-group">
                                    ...
                                    <select name = "ind" class="select-category form-control">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 nopadding">
                                <div class="form-group">
                                    <select name = "loc" class="select-location form-control">
                                        <option value="">&nbsp;</option>
                                        <option value="Trivandrum">Trivandrum</option>
                                        <option value="Palakkad">Palakkad</option>
                                        <option value="Allapuzha">Bahrain</option>
                                        <option value="Ernakulam">Canada</option>
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-12 nopadding">
                                <div class="form-group form-action">
                                    <button type="submit" id="sea" class="btn btn-default btn-search-submit">Search <i class="fa fa-angle-right"></i> </button>
                                </div>
                            </div>
                          </form>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <ul class="nav panel-tabs">
                                    <li> <a href="#tab1" name= "cat" data-toggle="tab"><i class="icofont icon-ribbon"></i><span class="hidden-xs hidden-sm">By Company</span></a> </li>
                                    <li> <a href="#tab2" name= "fun" data-toggle="tab"><i class="icofont icon-layers"></i><span class="hidden-xs hidden-sm">By Function</span></a> </li>
                                    <li class="active"> <a href="#tab3" name= "city" data-toggle="tab"><i class="icofont icon-global"></i><span class="hidden-xs hidden-sm">By City</span></a> </li>
                                    <li> <a href="#tab4" name= "type" data-toggle="tab"><i class="icofont icon-linegraph"></i><span class="hidden-xs hidden-sm">By Type</span></a> </li>
                                    <li> <a href="#tab5" name= "ind" data-toggle="tab"><i class="icofont icon-briefcase"></i><span class="hidden-xs hidden-sm">By Industry</span></a> </li>
                                </ul>
                            </div>
                        </div>
                                           ...
                                           $query= "SELECT * FROM jobs_list ORDER BY cid";
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <div class="job-title-box"> <a href="#">
                                                  ...
                                                  </a> <a href="#"><span class="comp-name"><?php echo $rw['name']; ?></span></a> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <div class="job-location"> <i class="fa fa-location-arrow"></i> <?php echo $row['location']; ?> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                      <div class="job-box">
                                        <?php
                                         ...
                                         $query= "SELECT * FROM jobs_list ORDER BY job_type";
                                          $data = mysqli_query($con,$query) or die("Fail17");
    ...
    <div class="brand-logo-area clients-bg">
        <div class="clients-list">
            <div class="client-logo"> <a href="#"><img src="images/clients/client_1.png" class="img-responsive" alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_2.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_3.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_4.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_1.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_2.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_3.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            <div class="client-logo"> <a href="#"><img src="images/clients/client_4.png" class="img-responsive"  alt="Brand Image" /></a> </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-md-3 col-xs-12">
                        <div class="footer_block"> <a href="index.html" class="f_logo"><img src="images/logo.png" class="img-responsive" alt="logo"></a>
...
<!-- Mirrored from templates.scriptsbundle.com/opportunities-v3/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2017 14:08:48 GMT -->
</html>
