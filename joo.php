                    ...
                    <div class="search-form-contaner">
                           ...
                           <!--  <div class="col-md-6 col-sm-4 col-xs-12 nopadding">
                             ...
                             <div class="col-md-3 col-sm-3 col-xs-12 nopadding">
                                 <form action="josearch.php" name="search">
                                <div class="form-group">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <ul class="nav panel-tabs">
                                    ...
                                    <li class="active"> <a href="#tab3" name= "city" data-toggle="tab"><i class="icofont icon-global"></i><span class="hidden-xs hidden-sm">By Job Type</span></a> </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                        <div class="job-box">
                                          <?php
                                           ...
                                           $query= "SELECT * FROM jobs_list ORDER BY title";
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <div class="job-title-box"> <a href="#">
                                                  ...
                                                  </a> <a href="#"><span class="comp-name"><?php echo $row['cid']; ?></span></a> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <div class="job-location"> <i class="fa fa-location-arrow"></i> <?php echo $row['state']; ?> </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <div class="job-type jt-full-time-color"> <i class="fa fa-clock-o"></i> <?php echo $row['expect_salary']; ?> </div>
                                            </div>
                                ...
                                <div class="tab-pane animated fadeInDown" id="tab2">
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                      <div class="job-box">
                                        ...
                                        $query= "SELECT * FROM jobs_list ORDER BY district";
                                          $data = mysqli_query($con,$query) or die("Fail17");
