...
<!-- Mirrored from templates.scriptsbundle.com/opportunities-v3/demo/user-edit-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2017 14:22:45 GMT -->
<head>
         ...
         <nav id="menu-1" class="mega-menu fa-change-black" data-color="">
            <section class="menu-list-items container">
                ...
                <ul class="menu-links pull-right">
                    ...
                    <li class="no-bg "  id="myBtn2"><a href="#" class="p-job"><i class="fa fa-plus-square"></i> Post a Job</a></li>
            ...
            <div id="side">
                    ...
                    <aside>
                                <form name=filter id=filter action="resu.php">
                                  <h3>State</h3>
                                  <select name = "state" >
