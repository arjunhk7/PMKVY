                    ...
                    <div class="search-form-contaner">
                           ...
                           <!--  <div class="col-md-6 col-sm-4 col-xs-12 nopadding">
                             ...
                             <div class="col-md-3 col-sm-3 col-xs-12 nopadding">
                                 <form action="resu.php" name="search">
                                <div class="form-group">
                                  <select name = "cat" class=" form-control">

                                    <option selected="selected" value=""> ----Job Category----</option>
                                    <?php
                            ...
                            <div class="col-md-3 col-sm-2 col-xs-12 nopadding">
                                <div class="form-group form-action">
                                    <button type="submit" class="form-control" style="height:45px;">Search <i class="fa fa-angle-right"></i> </button>
                                </div>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="tab-pane animated fadeInDown" id="tab2">
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                      <div class="job-box">
                                        ...
                                        $query= "SELECT * FROM employee_user ORDER BY address";
                                          $data = mysqli_query($con,$query) or die("Fail17");
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                                      <div class="job-box">
                                        <?php
                                             ...
                                             $query= "SELECT * FROM employee_user ORDER BY cert_id";
